package day03_EscapeSequence; // this is the package name of this class

public class Println_VS_Print2 {

    public static void main(String[] args) { // main method

        System.out.println("Knock Knock"); // first it prints knock knock, then it appends new line
        ...
        System.out.println("Hello everyone? how are you all today? Today we will... ");

        System.out.println("------------------------");

        System.out.print("Hello everyone, How are you all today?");
        System.out.print(" Today we will learn Escape Sequence's, ");
